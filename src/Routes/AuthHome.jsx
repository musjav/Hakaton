...
const AuthHome = () => {
  ...
  if (role === "admin") {
    ...
    if (path.startsWith("/signup") || path.startsWith("/login") || path === "/branchmanagerdashboard" || path === "/") {
      return (
        <>
    ...
    } else if (role === "branchmanagerdashboard") {
      // Manager cannot access user or admin routes
      if (path.startsWith("/signup") || path.startsWith("/login") || path === "/admin-dashboard" || path === "/") {
        return <Navigate to="/branchmanagerdashboard" replace />;
      }
    } else if (role === "user") {
      // User cannot access admin or manager routes
      if (path.startsWith("/signup") || path.startsWith("/login") || path === "/admin-dashboard" || path === "/branchmanagerdashboard") {
